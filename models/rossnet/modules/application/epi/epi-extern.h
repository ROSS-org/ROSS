 ...
 * epi-num.c
 */
extern void epi_num_check_report(epi_state * state, tw_lp * lp);
 ...
 */
extern void epi_seir_compute(epi_state * state, tw_bf * bf, tw_lp * lp);
...
extern int 		 g_epi_stay_home;

extern int		 g_epi_nreport_days;
extern int		*g_epi_report_days;
extern int		 g_epi_next_report_day;
