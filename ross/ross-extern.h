...
extern void print_outq(tw_pe * me);
/*
 * tw-stats.c
 */
...
extern void tw_define_lps(tw_lpid nlp, size_t msg_sz, tw_lpid nrng);
...
extern unsigned int tw_memory_allocate(tw_memoryq * q, size_t buf_size, unsigned int);
